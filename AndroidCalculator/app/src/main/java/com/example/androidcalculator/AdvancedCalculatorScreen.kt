...
fun AdvancedCalculatorScreen(
    ...
    verticalButtons: List<String>,
    horizontalButtons: List<String>
){
    Scaffold(
        ...
        BoxWithConstraints(modifier = Modifier.padding(innerPadding)) {
            ...
            if (isLandscape) {
                Row(
                    ...
                    CalculatorButtonsGrid(horizontalButtons, 7, onButtonClick, modifier = Modifier.weight(1f))
                }
            } else {
                Column(
                    modifier = Modifier.fillMaxSize(),
                    ...
                    DisplayArea(display, modifier = Modifier.weight(0.4f))
                    HorizontalDivider()
